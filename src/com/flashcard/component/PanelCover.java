...
public class PanelCover extends javax.swing.JPanel {
    ...
    private void init() {
        ...
        add(title);
        description = new JLabel("Để giữ kết nối với chúng tôi, vui lòng");
        description.setForeground(new Color(245, 245, 245));
        add(description);
        description1 = new JLabel("đăng nhập với thông tin cá nhân của bạn");
    ...
    private void login(boolean login) {
        if (this.isLogin != login) {
            if (login) {
                title.setText("Xin chào, bạn bè!");
                description.setText("Nhập thông tin cá nhân của bạn");
                description1.setText("và bắt đầu hành trình với chúng tôi");
                button.setText("ĐĂNG KÝ");
            } else {
                title.setText("Chào mừng trở lại!");
                description.setText("Để giữ kết nối với chúng tôi, vui lòng");
    ...
    // End of biến khai báo//GEN-END:variables
}
