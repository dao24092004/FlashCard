...
public class ControllerUser extends javax.swing.JFrame {
    ...
    public ControllerUser(ModelUser user, ConntrollerLoginAndRegister conntrollerLoginAndRegister) {
        this.user = user;
    ...
    private void handleSearch(String keyword) {
        ...
        if (form2 != null) {
            form2.search(keyword); // Tìm kiếm trong Form_2
        }
    ...
    private void initComponents() {
        ...
        menu = new com.flashcard.component.Menu(user);
        mainPanel = new javax.swing.JPanel();

        setDefaultCloseOperation(javax.swing.WindowConstants.EXIT_ON_CLOSE);
        setSize(new Dimension(1200, 800)); // Đặt kích thước cố định cho JFrame
        ...
        panelBorder1Layout.setHorizontalGroup(
            panelBorder1Layout.createSequentialGroup()
                ...
                .addGroup(panelBorder1Layout.createParallelGroup(GroupLayout.Alignment.LEADING)
                    .addComponent(header2, GroupLayout.DEFAULT_SIZE, 960, Short.MAX_VALUE) // Thêm header2 vào panel
